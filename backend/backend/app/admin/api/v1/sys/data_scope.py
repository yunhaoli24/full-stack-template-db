...
@router.get('/all', summary='获取所有数据范围', dependencies=[DependsJwtAuth])  # pyright: ignore
...
@router.get('/{pk}', summary='获取数据范围详情', dependencies=[DependsJwtAuth])  # pyright: ignore
...
@router.get('/{pk}/rules', summary='获取数据范围所有规则', dependencies=[DependsJwtAuth])  # pyright: ignore
