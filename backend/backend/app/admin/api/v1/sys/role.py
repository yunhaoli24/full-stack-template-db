...
@router.get('/all', summary='获取所有角色', dependencies=[DependsJwtAuth])  # pyright: ignore
...
@router.get('/{pk}/menus', summary='获取角色菜单树', dependencies=[DependsJwtAuth])  # pyright: ignore
...
@router.get('/{pk}/scopes', summary='获取角色所有数据范围', dependencies=[DependsJwtAuth])  # pyright: ignore
...
@router.get('/{pk}', summary='获取角色详情', dependencies=[DependsJwtAuth])  # pyright: ignore
async def get_role(
    db: CurrentSession, pk: Annotated[int, Path(description='角色 ID')]
