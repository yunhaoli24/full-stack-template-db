...
@router.get('/all', summary='获取所有任务调度', dependencies=[DependsJwtAuth])  # type: ignore[misc]
...
@router.get('/{pk}', summary='获取任务调度详情', dependencies=[DependsJwtAuth])  # type: ignore[misc]
