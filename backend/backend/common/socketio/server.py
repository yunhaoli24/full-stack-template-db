...
# 创建 Socket.IO 服务器实例
sio = socketio.AsyncServer(  # pyright: ignore[reportGeneralTypeIssues]
    client_manager=socketio.AsyncRedisManager(  # pyright: ignore[reportGeneralTypeIssues]
...
@sio.event  # pyright: ignore[reportGeneralTypeIssues]
